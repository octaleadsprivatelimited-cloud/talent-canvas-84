    ...
    <div className="max-w-4xl space-y-10">
      ...
      <Section title="“Services” section">
        <Field
          ...
          onChange={(v) => update("services_eyebrow", v)}
        />
        <Field
          label="Heading"
          value={content.services_heading}
          onChange={(v) => update("services_heading", v)}
        />
        <Field
          label="Highlighted phrase (gets accent color)"
          value={content.services_heading_accent}
          onChange={(v) => update("services_heading_accent", v)}
        />
        <Field
          label="Intro paragraph"
          rows={3}
          value={content.services_intro}
          onChange={(v) => update("services_intro", v)}
        />
      </Section>
      ...
      <Section title="“Industries” section">
        <Field
          label="Eyebrow"
          value={content.industries_eyebrow}
          onChange={(v) => update("industries_eyebrow", v)}
        />
        <Field
          label="Heading"
          value={content.industries_heading}
          onChange={(v) => update("industries_heading", v)}
        />
        <Field
          label="Intro paragraph"
          rows={3}
          value={content.industries_intro}
          onChange={(v) => update("industries_intro", v)}
        />
        <Field
          label="Photo badge — big text"
          value={content.industries_badge_value}
          onChange={(v) => update("industries_badge_value", v)}
        />
        <Field
          label="Photo badge — small text"
          value={content.industries_badge_label}
          onChange={(v) => update("industries_badge_label", v)}
        />
      </Section>
      ...
      <Section title="“Process” section">
        <Field
          ...
          onChange={(v) => update("process_eyebrow", v)}
        />
        <Field
          label="Heading"
          value={content.process_heading}
          onChange={(v) => update("process_heading", v)}
        />
        <Field
          label="Highlighted phrase"
          value={content.process_heading_accent}
          onChange={(v) => update("process_heading_accent", v)}
        />
        <Field
          label="“Why us” heading"
          value={content.why_heading}
          onChange={(v) => update("why_heading", v)}
        />
        <Field
          label="“Why us” intro"
          rows={2}
          value={content.why_intro}
          onChange={(v) => update("why_intro", v)}
        />
        <ListEditor
      ...
      <Section title="Client / keyword ribbon">
        <p className="text-xs text-muted-foreground">
          Short uppercase phrases shown as a marquee strip.
        </p>
        <ListEditor
          label="Items"
      ...
      <Section title="“Testimonials” section heading">
        <Field
          ...
          onChange={(v) => update("testimonials_eyebrow", v)}
        />
        <Field
          label="Heading"
      ...
      <Section title="Final CTA banner">
        <Field
          ...
          onChange={(v) => update("cta_heading", v)}
        />
        <Field
          label="Description"
          rows={2}
          value={content.cta_description}
          onChange={(v) => update("cta_description", v)}
        />
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Field
            ...
            value={content.cta_primary_to}
            onChange={(v) => update("cta_primary_to", v)}
          />
          <Field
            label="Secondary button — label"
            value={content.cta_secondary_label}
            onChange={(v) => update("cta_secondary_label", v)}
          />
          <Field
            label="Secondary button — link"
            value={content.cta_secondary_to}
            onChange={(v) => update("cta_secondary_to", v)}
          />
        </div>
      </Section>
